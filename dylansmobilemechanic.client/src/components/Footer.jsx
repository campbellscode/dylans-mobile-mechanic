      ...
      <div className="container">
        <div className="footer__top">
          <div className="footer__brand">
            <img src={logo} alt="Dylan's Mobile Mechanic" className="footer__brand-logo" />
            <p className="footer__brand-desc">
              Professional mobile mechanic services in Cincinnati and Northern Kentucky.
            ...
            <div className="footer__social">
              ...
              <a href="#" className="footer__social-link" aria-label="Phone">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <div className="footer__contact-item">
              ...
              dylan@dylansmobilemechanic.com
            </div>
            <div className="footer__contact-item">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" />
        ...
        <div className="footer__bottom">
          <p className="footer__copy">
            &copy; {year} Dylan's Mobile Mechanic. All rights reserved.
          </p>
